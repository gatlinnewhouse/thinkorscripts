...
# Someone shared this indicator via a thread on Futures forum. I don't know the original name so I called it the reversal indicator. 
# It uses moving averages, [ZigZag pattern](https://usethinkscript.com/threads/zigzag-high-low-with-supply-demand-zones-for-thinkorswim.172/), 
# and [Fibonacci](https://usethinkscript.com/threads/auto-fib-fibonacci-levels-indicator-for-thinkorswim.14/) to generate reversal signals on your chart.
# https://usethinkscript.com/threads/trend-reversal-indicator-with-signals-for-thinkorswim.183/
#
# Scanner version here = https://tos.mx/vlVadom
